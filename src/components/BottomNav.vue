...
const feedActive = computed(() => route.path.startsWith('/feed'))
const addActive = computed(() => route.path === '/add')
</script>
...
<template>
  <nav class="bottomnav">
    ...
    <button type="button" @click="modals.openNote()">
      <svg
        width="22"
        height="22"
        viewBox="0 0 24 24"
    ...
    <RouterLink to="/add" :class="addActive ? 'on' : undefined">
      <svg
        width="22"
        height="22"
        viewBox="0 0 24 24"
